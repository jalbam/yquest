...
//Calculamos si se enviado el comando (y si no son solo espacios):
if (isset($HTTP_GET_VARS["comando"]) && trim(urldecode($HTTP_GET_VARS["comando"])) != "")
 {

    echo "<center><table border=\"1\" cellspacing=\"0\" cellpadding=\"5\" width=\"400\" align=\"center\"><tr><td width=\"400\" align=\"center\"><center><font size=\"3\" color=\"#000000\" face=\"courier\">";
...
//    echo "Comando enviado: <b>".urldecode($HTTP_GET_VARS["comando"])."</b><br>";
    ...
    $comando_matriz = explode(" ", strtoupper(trim(urldecode($HTTP_GET_VARS["comando"]))));
    ...
    if (sizeof($comando_matriz) == 1)
     {
        ...
        else { echo "<center><b>Debes escribir mas.</b></center>"; }
     }
...
//        if ($comando_matriz[2] != "CON" && $comando_matriz[2] != "A" && $comando_matriz[2] != "EN" && $comando_matriz[2] != "AL" && $comando_matriz[2] != "HA" && $comando_matriz[2] != "AH" && $comando_matriz[2] != "KON") {
        ...
        } else { echo "Demasiados parametros."; }
    }

    elseif (sizeof($comando_matriz > 6)) { echo "Demasiados parametros."; }
